...
class MTL_Decoder(nn.Module):
    def __init__(self, **model_params):
        ...
        if self.model_params['num_experts'] > 1 and 'Dec' in self.model_params['expert_loc'] and not self.ffidt:
    ...
    def forward(self, encoded_last_node, attr, ninf_mask, T=1.0, step=2):
        ...
        # all the reld- models use simple linear layer here instead of MoEs
